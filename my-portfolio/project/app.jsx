      ...
      <div className="hero-inner container">
        <div className="hero-text">
          ...
          <div className="hero-role">
            A <span className="role-pill">software engineer</span> crafting
            calm, considered software — one careful detail at a time.
          </div>
          <p className="hero-blurb">
            Currently at <strong>InfancyIT Ltd.</strong> &middot; Computer
            Science,{" "}
    ...
    <section id="about" className="container">
      ...
      <div className="about" style={{ marginTop: 48 }}>
        <div className="about-card reveal">
          <div className="pin" />
          <p>
            I'm a software engineer at <strong>InfancyIT Ltd.</strong>, where I
            focus on building products that feel calm, considered, and genuinely
            useful.
          </p>
          <p>
            I graduated in Computer Science from{" "}
            <strong>Shahjalal University of Science and Technology</strong>, and
            have spent the years since shipping products, contributing to teams,
            and quietly racking up hackathon wins on the weekends.
          </p>
          <p>
      ...
      <div className="timeline reveal" style={{ marginTop: 56 }}>
        <div className="timeline-item">
          <div className="timeline-card">
            ...
            <ul>
              <li>
                Specialized coursework in algorithms, systems, and software
                engineering
              </li>
  ...
  const items = [
    {
      ...
      meta: "placeholder · 2024",
      icon: "1st",
    },
    {
      title: "Runner-up — Regional CodeFest",
      meta: "placeholder · 2023",
      icon: "2nd",
    },
    {
      title: "Best UI Award — University Hack",
      meta: "SUST · 2023",
      icon: "UI",
    },
    {
      title: "Top 10 — Online AI Challenge",
      meta: "placeholder · 2023",
      icon: "AI",
    },
    {
      title: "Winner — InterUni Code Sprint",
      meta: "placeholder · 2022",
      icon: "CS",
    },
    {
      title: "Speaker — University Tech Talk",
      meta: "SUST · 2022",
      icon: "🎤",
    },
  ];
  ...
  const posts = [
    {
      ...
      excerpt:
        "A friendly guide to scoping, shipping, and not burning out at 3am.",
    },
    {
      date: "Feb 04, 2026",
      title: "Notes on Building Tiny Tools at Work",
      excerpt:
        "Small internal tools changed our team. Here's how I think about them.",
    },
    {
      date: "Jan 18, 2026",
      title: "From SUST to Software: A Friendly Roadmap",
      excerpt:
        "What I'd tell my first-year self about university, code, and craft.",
    },
  ];
  return (
    ...
    <section id="contact" className="container contact">
      ...
      <div className="contact-card reveal" style={{ marginTop: 56 }}>
        ...
        <div className="corner-doodle tr">
          <D.CornerBurst color="#b8e6c8" />
        </div>
        <div className="corner-doodle bl">
          <D.CornerBurst color="#ffc7a8" />
        </div>
        <div className="corner-doodle br">
          <D.CornerBurst color="#b9dcf2" />
        </div>
        ...
        <div className="contact-links">
          ...
          <a href="#" className="btn mint">
            GitHub
          </a>
          <a href="#" className="btn sky">
            LinkedIn
          </a>
          <a href="#" className="btn peach">
            Twitter
          </a>
        </div>
      </div>
...
function Footer() {
  return (
    <footer className="footer">
      Made with <span className="heart">♥</span> and a box of crayons — © 2026
      Bipul
    </footer>
  );
}

...
export const Route = createFileRoute('/admin/projects')({
  ...
  pendingComponent: () => <AdminPagePending subtitle="Loading your project list." title="Projects" />,
  headers: () => ({
...
function AdminProjectsPage() {
  ...
  return (
    ...
    >
      {projects.length ? (
        <AdminCard>
          <AdminSectionHeading action={<AdminActionLink to="/admin/projects/new">New project</AdminActionLink>} eyebrow="content" title="All projects" />
            ...
            {projects.map((project) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="mt-2 line-clamp-2 max-w-3xl text-sm text-ink-soft">{project.summary}</div>
                </div>

...
export function ProjectGrid({
  ...
  return (
    <>
      <div
        className="theme-only-crayon project-grid grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8"
            ...
            >
              <div
                className={cx(
                  ...
                  "project-card-cover relative flex min-h-32 items-center justify-center border-b-2 border-ink sm:min-h-40",
                )}
              >
              ...
              <div className="project-card-body flex h-full flex-col px-5 pb-5 pt-4 sm:px-[1.375rem] sm:pb-[1.375rem] sm:pt-5">
                ...
                <div className="project-card-tags mb-3.5 flex flex-wrap gap-2">
      ...
      <MinimalProjectGrid emptyText={emptyText} emptyTitle={emptyTitle} items={items} />
    </>
  );
}

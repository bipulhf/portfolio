...
export const PUBLIC_THEME_CONFIG: Record<PublicTheme, PublicThemeConfig> = {
  ...
  minimal: {
    footerText: 'Selected work, hackathon instincts, quiet systems. © YEAR Bipul Hf',
    hero: {
      artAlt: 'Minimal hero artwork for Bipul portfolio mode',
      artSrc: '/minimal-portrait.svg',
      ctaPrimary: 'Open selected work',
      ctaSecondary: 'Contact',
      intro: 'portfolio / minimal',
      lead: 'Software engineer focused on calm interfaces, dependable systems, and product decisions that still hold up when the pressure climbs.',
    ...
    pages: {
      blog: {
        description:
          'Short writing on interface clarity, engineering judgment, and the decisions behind the work.',
        eyebrow: 'Notes',
        primaryLabel: 'Home',
        secondaryLabel: 'Projects',
        title: 'Writing, reduced',
      },
      projects: {
        description:
          'A concise set of projects showing interface craft, product thinking, and system reliability.',
        eyebrow: 'Selected work',
        primaryLabel: 'Home',
        secondaryLabel: 'Notes',
        title: 'Projects, reduced',
      },
    },
  },
}

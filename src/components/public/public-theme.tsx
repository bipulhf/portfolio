...
export const PUBLIC_THEME_CONFIG: Record<PublicTheme, PublicThemeConfig> = {
  crayon: {
    ...
    home: {
      ...
      seoDescription:
        "A crayon-styled portfolio for Bipul featuring projects, writing, and achievements.",
      workDescription:
  ...
  minimal: {
    ...
    home: {
      ...
      seoDescription:
        "A reduced minimalist portfolio for Bipul focused on selected work and direct contact.",
      workDescription:
    ...
    meta: {
      blog: {
        description:
          "Short writing by Bipul on product systems, frontend clarity, and build decisions.",
        title: "Notes — Bipul",
      },
      home: {
        description:
          "A reduced minimalist portfolio for Bipul focused on selected work and direct contact.",
        title: "Bipul — Minimal Portfolio",
      },
      projects: {
        description:
          "A concise view of shipped interfaces, product systems, and build decisions by Bipul.",
        title: "Selected Work — Bipul",
      },
    },
    nav: {
      ctaHref: "/#contact",
    ...
    pages: {
      blog: {
        description:
          "Short writing on product work, interface decisions, and software craft.",
      ...
      projects: {
        description:
          "Selected builds, shipped interfaces, and engineering case studies.",
...
export function PublicThemeProvider({
  ...
  useEffect(() => {
    ...
    function handleStorage(event: StorageEvent) {
      if (
        event.key !== PUBLIC_THEME_STORAGE_KEY ||
        !isPublicTheme(event.newValue)
      ) {
        return;
      }
  ...
  function updateTheme(
    nextTheme: PublicTheme,
    options?: { animate?: boolean },
  ) {
    const shouldAnimate =
      options?.animate === true && shouldAnimateThemeTransition();

...
export function RouteProgress() {
  ...
  return (
    <div
      aria-hidden="true"
      className={`route-progress-shell pointer-events-none fixed inset-x-0 top-3 z-[120] transition-opacity duration-150 ${isLoading ? 'opacity-100' : 'opacity-0'}`}
    >
      <div className="mx-auto max-w-[73.75rem] px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="route-progress-track relative h-2 w-full max-w-[11rem] overflow-hidden rounded-full border border-ink/15 bg-white/80 shadow-[2px_2px_0_rgba(46,61,58,0.14)]">
